...
export function FeatureCard({ icon, title, description, index }: FeatureCardProps) {
  return (
    <motion.div
      ...
      className="group relative rounded-xl border border-white/5 bg-[#0a0a0a] p-6 transition-all duration-300 hover:border-[#DC2626]/30 hover:shadow-[0_0_30px_rgba(220,38,38,0.08)] hover:bg-[#0d0909] hover:-translate-y-1"
    >
