...
const wallets = [
  { name: "Solana", symbol: "SOL", address: "2kxNKcWXPwBSjmhogZLVJKFgTAotiMS82d4cTB2EXB9V", icon: "◎" },
  { name: "Ethereum", symbol: "ETH", address: "0x4C57D508F3FE6A4AD49B500dea36f83235a78d26", icon: "⟠" },
  { name: "Bitcoin", symbol: "BTC", address: "bc1qa4kqtc6rs2fxepycsn0hds5gfmkj6dtrcgmsmh", icon: "₿" },
];
